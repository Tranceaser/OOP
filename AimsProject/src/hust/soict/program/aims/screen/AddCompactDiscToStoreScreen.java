...
import hust.soict.program.aims.screen.controller.AddCDScreenController;
...
public class AddCompactDiscToStoreScreen extends JFrame{
    ...
    public AddCompactDiscToStoreScreen(Store store) {
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/hust/soict/program/aims/screen/view/addCD.fxml"));
