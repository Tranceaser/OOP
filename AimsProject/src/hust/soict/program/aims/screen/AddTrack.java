...
import hust.soict.program.aims.media.CompactDisc;
import hust.soict.program.aims.screen.controller.AddTrackScreenController;
...
public class AddTrack extends JFrame{
    ...
    public AddTrack(CompactDisc CD) {
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/hust/soict/program/aims/screen/view/addTracks.fxml"));
